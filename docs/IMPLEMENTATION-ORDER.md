...
3. 运行与改动相称的自动检查，按真实失败修复。
4. 通过 [ComputerUse 用户验收](https://github.com/KRPCT/InkStream/issues/48)，记录实际点击、键盘、拖动与写作结果。

真实账户、物理 IME 与跨平台完整矩阵由专项票据推进。当前指令已授权本地 UX 实现，不再以所有外部验收为前置。
