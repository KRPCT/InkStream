...
| # | 阶段 | 交付物 | 状态 |
|---|------|--------|------|
| 1 | 应用骨架与三模式 Workbench | Tauri 壳、五插槽布局、三模式预设与主题、命令面板 | 已完成 |
| 2 | CM6 单内核与工作区文件 | 唯一编辑器实例、11 种语言高亮、文件树、快速打开 | 已完成 |
| 3 | Live Preview 装饰层 | Source/Live Preview 切换、光标行还原、中文 IME 保障 | 已完成 |
...
*更新于 2026-06-10：路线图建立。2026-06-11：Phase 1 完成。2026-06-12：Phase 2 / Phase 3 完成；编辑器内核完成统一 IME 冻结门重构（组合期换装 / 重载 / 落盘 / 装饰刷新单点收口，全渲染模式在册）。*
